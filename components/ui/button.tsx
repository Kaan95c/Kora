...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-sm hover:-translate-y-px hover:shadow-card",
        secondary:
          "bg-secondary-container text-on-surface hover:-translate-y-px hover:shadow-card",
        ghost:
          "border-[1.5px] border-primary bg-transparent text-primary hover:bg-primary-light/40 hover:-translate-y-px",
        outline:
          "border border-outline-variant bg-surface text-on-surface hover:bg-surface-low",
        destructive:
          "bg-destructive text-destructive-foreground hover:-translate-y-px hover:shadow-card",
